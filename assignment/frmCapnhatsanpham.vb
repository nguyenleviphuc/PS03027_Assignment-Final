...
Public Class frmCapnhatsanpham
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        ...
        connect.Open()
        Dim xem As SqlDataAdapter = New SqlDataAdapter("select SANPHAM1.MASP as 'Mã sản phẩm',SANPHAM1.TENSP as 'Tên sản phẩm', LOAISANPHAM1.MALOAI as 'Mã Loại', LOAISANPHAM1.TENLOAI as 'Tên Loại',SANPHAM1.SOLUONG as 'Số lượng' from SANPHAM1 inner join LOAISANPHAM1 on SANPHAM1.MASP = LOAISANPHAM1.MASP where SANPHAM1.MASP='" & txtMASP.Text & "'", connect)
        Try
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim load As SqlDataAdapter = New SqlDataAdapter("select SANPHAM1.MASP as 'Mã sản phẩm',SANPHAM1.TENSP as 'Tên sản phẩm', LOAISANPHAM1.MALOAI as 'Mã Loại', LOAISANPHAM1.TENLOAI as 'Tên Loại',SANPHAM1.SOLUONG as 'Số lượng' from SANPHAM1 inner join LOAISANPHAM1 on SANPHAM1.MASP = LOAISANPHAM1.MASP", conn)
    ...
    Private Sub btnCapnhat_Click(sender As Object, e As EventArgs) Handles btnCapnhat.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim updatequery As String = "update SANPHAM1 set MASP=@MASP, TENSP=@TENSP, SOLUONG=@SOLUONG where MASP=@MASP update LOAISANPHAM1 set MALOAI=@MALOAI, MASP=@MASP, TENLOAI=@TENLOAI where MASP=@MASP"
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        Dim delquery As String = "delete from SANPHAM1 where MASP=@MASP delete from LOAISANPHAM1 where MASP=@MASP"
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim query As String = "insert into SANPHAM1 values(@MASP,@TENSP,@SOLUONG) insert into LOAISANPHAM1 values(@MALOAI,@MASP,@TENLOAI)"
        ...
        Dim refesh As SqlDataAdapter = New SqlDataAdapter("select SANPHAM1.MASP as 'Mã sản phẩm',SANPHAM1.TENSP as 'Tên sản phẩm', LOAISANPHAM1.MALOAI as 'Mã Loại', LOAISANPHAM1.TENLOAI as 'Tên Loại',SANPHAM1.SOLUONG as 'Số lượng' from SANPHAM1 inner join LOAISANPHAM1 on SANPHAM1.MASP = LOAISANPHAM1.MASP", conn)
        db.Clear()
        refesh.Fill(db)
        dgvSanpham.DataSource = db.DefaultView
    End Sub
